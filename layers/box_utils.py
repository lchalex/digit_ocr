...
def match(threshold, truths, priors, variances, labels, loc_t, conf_t, neu_t, idx, device):
    ...
    neu = torch.zeros_like(conf, dtype=torch.bool)
    conf[best_truth_overlap < threshold] = 0  # label as background
    neu[(best_truth_overlap < threshold) & (best_truth_overlap > threshold / 5)] = True  # label as neutral
